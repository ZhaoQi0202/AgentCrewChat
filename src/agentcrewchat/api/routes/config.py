...
from agentcrewchat.config.loader import (
    delete_skill_entry,
    load_all,
    save_mcp_entry,
    save_skill_entry,
)
from agentcrewchat.config.llm_settings_store import load_llm_settings, save_llm_settings
from agentcrewchat.config.model_connection_store import (
    allocate_connection_id,
    delete_model_connection_entry,
    list_model_connections,
    save_model_connection_entry,
)
from agentcrewchat.config.models import (
    LlmSettings,
    McpEntry,
    ModelConnectionEntry,
    SkillEntry,
)
from agentcrewchat.llm.connection_check import probe_model_connection
from agentcrewchat.paths import install_root
from agentcrewchat.skills.skill_import import import_skills_from_input
...
async def remove_mcp(mcp_id: str) -> dict[str, str]:
    ...
    import json
    from agentcrewchat.config.manifest import load_manifest, write_manifest_dict
