...
from agentcrewchat.config.llm_settings_store import load_llm_settings
from agentcrewchat.config.model_connection_store import load_model_connection
from agentcrewchat.config.models import ModelConnectionEntry
from agentcrewchat.paths import config_dir
from agentcrewchat.llm.connection_check import normalize_openai_base_url


class _FixedFakeChatModel(SimpleChatModel):
    @property
    def _llm_type(self) -> str:
        return "agentcrewchat-fake-chat"
